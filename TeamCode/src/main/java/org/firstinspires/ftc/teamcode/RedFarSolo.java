...
public class RedFarSolo extends AutonomousDefinitions {
    public void route(){
        new SequentialCommandGroup(
                ...
                firstLaunch(),
                getPath(Constants.getMatchPattern())
        ).schedule();
    }

    @Override
    protected void structurePaths() {
        addPath(Pattern.BOTTOM, new SequentialCommandGroup(
        ...
        addPath(Pattern.MID, new SequentialCommandGroup(
        ...
        addPath(Pattern.TOP, new SequentialCommandGroup(
